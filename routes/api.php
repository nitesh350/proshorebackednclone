...
use App\Http\Controllers\Api\Admin\GetQuestionCategories;
...
Route::group(['prefix' => 'admin', 'middleware' => 'auth:sanctum'], function () {
    ...
    Route::get('/question-categories-for-creation', GetQuestionCategories::class)->middleware('abilities:manage-questions,manage-question-categories');
});
